       ...
       <main className="flex-1 px-6 py-12">
         <div className="max-w-4xl mx-auto">
           ...
           <div className="text-center mb-16">
             ...
             <p className="text-[#6b665f] text-lg leading-relaxed max-w-2xl mx-auto">
              Hier findest du Übungen für den Unterricht und interessante Studien
              zum Thema Klassenklima.
             </p>
           </div>
           ...
           <div className="grid md:grid-cols-2 gap-12 max-w-3xl mx-auto">
             ...
             >
               <div className="bg-[#f4f1ea] px-8 py-10">
                 <svg
                  viewBox="0 0 120 120"
                 ...
                 >
                   ...
                   <path
                    ...
                    fill="none"
                   />
                   <path d="M 40 30 L 80 30" stroke="#4a403a" strokeWidth="0.8"/>
                   <path d="M 40 40 L 80 40" stroke="#4a403a" strokeWidth="0.8"/>
                   <path d="M 40 50 L 60 50" stroke="#4a403a" strokeWidth="0.8"/>
                 </svg>
                 <h3
               ...
               <div className="bg-[#f4f1ea] px-8 py-10">
                 ...
                 >
                   ...
                   <rect
                    ...
                    fill="none"
                   />
                   <path d="M 35 25 L 85 25" stroke="#4a403a" strokeWidth="1.5"/>
