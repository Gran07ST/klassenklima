           ...
           {/* Introduction */}
            ...
            <div className="space-y-6">
              {data.themenBereiche.map((thema, index) => (
                <div
                key={index}
                className="border-b border-[#e8e5df] pb-8 last:border-b-0"
                >
                  <h3
                  ...
                  className="mt-4 group inline-flex items-center gap-2 text-[#6b665f] hover:text-[#4a403a] transition-colors duration-300"
                  >
                  ...
                  {expanded === thema.titel && (
                    <div className="mt-4 ml-4 border-l-2 border-[#e8e5df] pl-6 animate-fade-in-up">
                      <p className="text-[#6b665f] leading-relaxed">
                        {thema.inhalt}
                      </p>
                    </div>
