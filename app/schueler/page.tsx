        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12 md:mb-16">
            ...
            <p className="text-[#6b665f] text-base md:text-lg leading-relaxed max-w-2xl mx-auto">
              Mache mit beim Fragebogen und erhalte personalisierte Tipps für
              dein Klassenklima.
            </p>
          </div>
              ...
              <div className="bg-[#f4f1ea] px-6 py-8 md:px-8 md:py-10">
                ...
                >
                  ...
                  <rect
                    ...
                    fill="none"
                  />
                  <path d="M 30 25 L 90 25" strokeWidth="1.5" />
                  <circle cx="40" cy="40" r="4" fill="var(--accent)" />
                  <circle cx="40" cy="55" r="4" fill="var(--accent)" />
                  <circle cx="40" cy="70" r="4" fill="var(--accent)" />
                  <path d="M 50 40 L 80 40" strokeWidth="1" />
                  <path d="M 50 55 L 80 60" strokeWidth="1" />
                  <path d="M 50 70 L 75 75" strokeWidth="1" />
                </svg>
                <h3
              ...
              <div className="bg-[#f4f1ea] px-6 py-8 md:px-8 md:py-10">
                ...
                >
                  ...
                  <path
                    ...
                    fill="none"
                  />
                  <path d="M 60 60 L 92 60" strokeWidth="1.5" />
                  <path
                    d="M 60 60 L 92 60 A 35 35 0 0 1 60 95 Z"
                    strokeWidth="1.5"
                    fill="none"
                  />
                  <path d="M 60 60 L 60 95" strokeWidth="1.5" />
                </svg>
                <h3
                  className="text-lg md:text-xl font-light tracking-tight text-[#2d2a26] mt-4 md:mt-6 text-center"
                  style={{ fontFamily: '"Playfair Display", serif' }}
              ...
              <div className="bg-[#f4f1ea] px-6 py-8 md:px-8 md:py-10">
                ...
                >
                  ...
                  <path
                    ...
                    fill="none"
                  />
                  <path d="M 58 90 L 62 90" strokeWidth="1.5" />
                </svg>
                <h3
                  className="text-lg md:text-xl font-light tracking-tight text-[#2d2a26] mt-4 md:mt-6 text-center"
                  style={{ fontFamily: '"Playfair Display", serif' }}
