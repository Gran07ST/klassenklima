...
export default function StatCard({ zahl, aussage, quelle, details }: StatCardProps) {
  return (
     <Card className="border-[#e8e5df] hover:border-[#d4d0c8] transition-colors duration-300">
       <CardContent className="p-8">
          <div className="flex flex-col items-start">
            {/* Large number */}
            <div className="text-5xl font-light text-[#2d2a26] mb-4" style={{ fontFamily: '"Playfair Display", serif' }}>
              {zahl}
            </div>
            {/* Statement */}
